...
class CustomDatasetFromImages(Dataset):
    def __init__(self, csv_path, transform=None):
        ...
        # Get label
        self.label = np.asarray(self.data_info.iloc[:, 2])
        # Calculate len
    ...
    def __getitem__(self, index):
        ...
        sample = (img_as_img, img_as_img_second, label)
...
if __name__ == '__main__':
    arg = '/datac/nkanama/FFHQ-FAKE/fakeImagesProcessed/text_files/testFFHQ.csv'
    main(arg)
